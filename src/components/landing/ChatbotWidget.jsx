      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-32 left-4 sm:bottom-24 sm:left-6 z-[10000] w-[calc(100vw-2rem)] sm:w-96 h-[calc(100vh-14rem)] sm:h-[600px] max-h-[calc(100vh-14rem)] sm:max-h-[calc(100vh-2rem)] bg-white rounded-3xl shadow-2xl flex flex-col overflow-hidden border border-[#D4AF37]/20"
          >
            {/* Header */}
