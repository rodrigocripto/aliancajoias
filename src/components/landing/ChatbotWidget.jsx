      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-28 left-4 sm:bottom-6 sm:left-6 z-[10000] w-[calc(100vw-2rem)] sm:w-96 h-[calc(100vh-14rem)] sm:h-[600px] max-h-[calc(100vh-14rem)] sm:max-h-[calc(100vh-2rem)] bg-white rounded-3xl shadow-2xl flex flex-col overflow-hidden border border-[#D4AF37]/20"
          >
            {/* Header */}
                        ...
                        components={{
                          ...
                          a: ({ href, children }) => (
                            <a 
                              ...
                              className="inline-flex items-center gap-1 px-3 py-1.5 mt-2 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full text-xs font-medium transition-colors duration-200"
                            >
